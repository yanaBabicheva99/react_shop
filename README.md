...
- `npm run start: build` - Сборка в prod режиме
...
Разрешено испошльзовать только с помощью хелпера 
...
Для автоматического удаления фичи используется скрипт removeFeature, 
...
- [ArticleInfinityList](/src/features/ArticleInfinityList)
- [ArticleRating](/src/features/ArticleRating)
- [ArticlesSort](/src/features/ArticlesSort)
- [AuthByUsername](/src/features/AuthByUsername)
- [AvatarButton](/src/features/AvatarButton)
- [EditableProfileCard](/src/features/EditableProfileCard)
- [LangSwitcher](/src/features/LangSwitcher)
- [ThemeSwitcher](/src/features/ThemeSwitcher)
- [NotificationButton](/src/features/NotificationButton)
- [RecommendationArticleList](/src/features/RecommendationArticleList)
- [ThemeSwitcher](/src/features/ThemeSwitcher)
- [ScrollTracking](/src/features/ScrollTracking)
