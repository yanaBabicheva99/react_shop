...
import { getSearchType, getSortField, getSortOrder, getSortSearch } from '../../model/selector/getArticlesSort';
    ...
    return (
        <DynamicModuleLoader reducers={reducer}>
            <div className={classNames(cls.ArticlesSort, {}, [className])}>
                ...
                <Tabs<ArticleType> tabs={tabs} value={type} onChange={handleChangeType} />
            </div>
        </DynamicModuleLoader>
    );
});
